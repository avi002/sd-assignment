            ...
            <form method="POST" action="{{URL::to('update-student/'.$student->id)}}">
                ...
                <div class="row row-space">
                    <div class="col-6">
                        ...
                        <input class="input--style-4" type="text" name="fname" value="{{$student->fname}}">
                    ...
                    <div class="col-6">
                        <div class="input-group">
                            ...
                            <input class="input--style-4" type="text" name="lname" value="{{$student->lname}}">
                            @if ($errors->first('fname'))
                ...
                <div class="row row-space">
                    <div class="col-6">
                        <div class="input-group">
                            ...
                            <input class="input--style-4 js-datepicker" type="date" name="dob" value="{{$student->dob}}">
                ...
                <div class="row row-space">
                    ...
                    <div class="col-6">
                        ...
                        <input class="input--style-4" type="number" name="mobile" value="{{$student->mobile}}">
